...
public final class MessageConstants {
    ...
    public static final String PASSWORD_NAME_REQUIRED = "Password name is required";
    public static final String PASSWORD_DATA_REQUIRED = "Password data is required";
    public static final String INVALID_PASSWORD_NAME = "Invalid password name format";
    public static final String PASSWORD_NAME_TOO_LONG = "Password name is too long";
