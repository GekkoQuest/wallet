...
public class SecurityAuditService {
    ...
    public void logSecurityEvent(SecurityEventType eventType, String userIdentifier,
                                 String details, String ipAddress) {
        log.info("SECURITY_EVENT: {} | User: {} | IP: {} | Details: {}",
                eventType, userIdentifier, ipAddress, details);
    ...
    public void logPasswordAccess(String email, String ipAddress, String action) {
        logSecurityEvent(SecurityEventType.PASSWORD_ACCESS, email, action, ipAddress);
    }

    public void logSuspiciousActivity(String identifier, String ipAddress, String activity) {
